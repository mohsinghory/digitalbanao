  ...
  const portfolioItems = [
    {
      ...
      description:
        "Career Counseling Platform built with React, Node.js, and MySQL for a retail client.",
      image:
      ...
      caseStudyUrl: "https://careerbanao.org/",
    },
    {
      title: "Business Management App",
      description:
        "Comprehensive business management application with real-time analytics and reporting.",
      image:
    ...
    },
    {
      ...
      description:
        "Secure healthcare management portal with patient records and appointment scheduling.",
      image:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Discover some of our recent projects and successful digital
            transformations
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {portfolioItems.map((item, index) => (
            <Card
              key={index}
              className="portfolio-card overflow-hidden border-0 shadow-lg"
            >
